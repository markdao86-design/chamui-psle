...
const CHAMUI = {
  ...
  renderCharacter(state) {
    ...
    const autoShirt = level.lv <= 3 ? '#FFE066' : level.lv <= 6 ? '#FF9F45' : level.lv <= 8 ? '#A788E0' : '#E64C4C';
    ...
    ` : `
      ...
      <ellipse cx="110" cy="110" rx="9" ry="3.5" fill="#E64C4C"/>
    `;
    ...
    const body = `
      ...
      <!-- 腮红 (原始位置) -->
      <ellipse cx="76" cy="92" rx="9" ry="5" fill="#E64C4C" opacity="0.55"/>
      <ellipse cx="144" cy="92" rx="9" ry="5" fill="#E64C4C" opacity="0.55"/>
    ...
    const fireBackground = has.fire ? `
      <g opacity="0.7">
        <path d="M 28 ${tpl.legBottom + 6} Q 25 ${tpl.legBottom - 8} 32 ${tpl.legBottom - 16} Q 35 ${tpl.legBottom - 4} 40 ${tpl.legBottom - 12} Q 42 ${tpl.legBottom + 2} 38 ${tpl.legBottom + 6} Z" fill="#E64C4C">
    ...
    const monthking = has.monthking ? `
      ...
      <circle cx="${A.chest[0]}" cy="${A.chest[1]+10}" r="6.5" fill="#E64C4C" stroke="#8090A0" stroke-width="1.5"/>
    ...
    const shield = has.shield ? `
      <g>
        <g transform="translate(${A.handL[0]-3}, ${A.handL[1]-3})">
          ...
          <circle cx="0" cy="-1" r="2" fill="#E64C4C"/>
        </g>
        ${gripL}
      </g>
    ` : '';
    ...
    const note = (has.note && !has.shield && !has.tube && !has.cert) ? `
      <g>
        <g transform="translate(${A.handL[0]+2}, ${A.handL[1]+2}) rotate(-8)">
          ...
          <line x1="-8" y1="-9" x2="8" y2="-9" stroke="#E64C4C" stroke-width="1"/>
    ...
    const cert = has.cert ? `
      <g>
        <g transform="translate(${A.handL[0]+5}, ${A.handL[1]-2}) rotate(8)">
          ...
          <circle cx="6" cy="2" r="3.5" fill="#E64C4C" stroke="#8090A0" stroke-width="0.8"/>
    ...
    const heroMask = (skin.accessory === 'heroMask') ? `
      <path d="M ${A.eyeL[0]-14} ${A.eyeL[1]-7}
            ...
            fill="#E64C4C" stroke="#8090A0" stroke-width="2.5" opacity="0.92"/>
    ...
    const headphone = has.headphone ? `
      <g>
        ...
        <path d="M ${A.earL[0]-2} ${A.earL[1]-12} Q 110 ${A.headTop[1]-6} ${A.earR[0]+2} ${A.earR[1]-12}"
              stroke="#E64C4C" stroke-width="3" fill="none"/>
        <!-- 左耳罩贴耳 -->
        <ellipse cx="${A.earL[0]-3}" cy="${A.earL[1]+2}" rx="9" ry="13" fill="#E64C4C" stroke="#8090A0" stroke-width="2.5"/>
        <ellipse cx="${A.earL[0]-3}" cy="${A.earL[1]+2}" rx="5" ry="9" fill="#2D3047" opacity="0.6"/>
        <!-- 右耳罩贴耳 -->
        <ellipse cx="${A.earR[0]+3}" cy="${A.earR[1]+2}" rx="9" ry="13" fill="#E64C4C" stroke="#8090A0" stroke-width="2.5"/>
    ...
    const crown = (has.crown && !has.sun && !has.streak100 && skin.accessory !== 'masterCrown') ? `
      <g>
        ...
        <!-- 宝石 -->
        <circle cx="${110-tpl.headR+4}" cy="${A.headTop[1]-7}" r="3" fill="#E64C4C" stroke="#8090A0" stroke-width="1"/>
        <circle cx="110" cy="${A.headTop[1]-12}" r="4" fill="#E64C4C" stroke="#8090A0" stroke-width="1"/>
        <circle cx="${110+tpl.headR-4}" cy="${A.headTop[1]-7}" r="3" fill="#E64C4C" stroke="#8090A0" stroke-width="1"/>
    ...
    const phoenix = has.phoenix ? `
      <g>
        ...
        <path d="M 105 ${A.headTop[1]-2} Q 95 ${A.headTop[1]-15} 90 ${A.headTop[1]-25}
                 Q 92 ${A.headTop[1]-15} 100 ${A.headTop[1]-8} Z" fill="#E64C4C" stroke="#8090A0" stroke-width="1.5"/>
        ...
        <!-- 火焰小颗 -->
        <circle cx="105" cy="${A.headTop[1]-32}" r="2" fill="#E64C4C" opacity="0.8">
    ...
    const masterCrown = (skin.accessory === 'masterCrown') ? `
      <g>
        ...
        <rect x="${110-tpl.headR-4}" y="${A.headTop[1]+7}" width="${(tpl.headR+4)*2}" height="7"
              fill="#FFA500" stroke="#8090A0" stroke-width="2"/>
        <circle cx="${110-tpl.headR+4}" cy="${A.headTop[1]-10}" r="3" fill="#E64C4C" stroke="#8090A0" stroke-width="1"/>
    ...
    const rainbow = has.rainbow ? `
      <g opacity="0.55">
        <ellipse cx="110" cy="${(tpl.headCY + tpl.legBottom)/2}" rx="100" ry="115" fill="none" stroke="#E64C4C" stroke-width="3"/>
    ...
    const streak30 = has.streak30 ? `
      <g opacity="0.7">
        <path d="M 30 ${tpl.legBottom-5} Q 25 ${tpl.bodyTop+30} 50 ${tpl.headCY} Q 70 ${A.headTop[1]-5} 110 ${A.headTop[1]-15}
              ...
              fill="none" stroke="#E64C4C" stroke-width="3" stroke-dasharray="6 4">
    ...
    ` : has.apple ? `
      ...
      <g transform="translate(${A.waistL[0]+4}, ${A.waistL[1]+4})">
        <circle cx="0" cy="2" r="5" fill="#E64C4C" stroke="#8090A0" stroke-width="1.5"/>
    ...
    const cake = has.cake ? `
      <g filter="url(#eqShadowBig)">
        ...
        <g transform="translate(162, ${tpl.legBottom-14})">
          ...
          <line x1="-1.5" y1="-22" x2="1.5" y2="-22" stroke="#E64C4C" stroke-width="0.8"/>
          <line x1="-1.5" y1="-25" x2="1.5" y2="-25" stroke="#E64C4C" stroke-width="0.8"/>
          <!-- 蜡烛火苗 (3 层 + 跳动) -->
          ...
          <circle cx="-9" cy="-2" r="1.3" fill="#E64C4C" stroke="#8090A0" stroke-width="0.5"/>
    ...
    const sock = has.sock ? `
      <g>
        ...
        <line x1="${91-7}" y1="${tpl.legBottom-9}" x2="${91+7}" y2="${tpl.legBottom-9}" stroke="#E64C4C" stroke-width="1.5"/>
        <line x1="${129-7}" y1="${tpl.legBottom-9}" x2="${129+7}" y2="${tpl.legBottom-9}" stroke="#E64C4C" stroke-width="1.5"/>
      </g>
    ` : '';
    ...
    const unicorn = has.unicorn ? `
      <g class="unicorn-ride">
        ...
        <g transform="translate(110, ${tpl.legBottom + 5})">
          ...
          <line x1="-49" y1="-16" x2="-43" y2="-16" stroke="#E64C4C" stroke-width="1.2"/>
          ...
          <!-- 嘴 -->
          <path d="M -50 4 Q -46 7 -42 4" stroke="#E64C4C" stroke-width="1.5" fill="none" stroke-linecap="round"/>
          <!-- 尾巴 (彩虹色, 飘动) -->
          ...
          <!-- 缰绳 -->
          <path d="M -35 -4 Q -25 -8 -10 -6" stroke="#E64C4C" stroke-width="1.5" fill="none"/>
        </g>
        <!-- 速度线 (后方残影) -->
      ...
      <svg viewBox="-20 -10 270 270" xmlns="http://www.w3.org/2000/svg">
        <defs>
          ...
          <linearGradient id="metalRed" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            <stop offset="40%" stop-color="#E64C4C"/>
          ...
          <radialGradient id="appleSphere" cx="35%" cy="30%">
            ...
            <stop offset="60%" stop-color="#E64C4C"/>
            <stop offset="100%" stop-color="#A03030"/>
          </radialGradient>

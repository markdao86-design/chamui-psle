...
- **UI 收尾 + 内容 5 项** (v19.14i): **字号 11/10→13/12 全局升** (WCAG AA, 累计 4 版未做) / **9 tab→5 tab** (📚 练习 hub 合并知识树+题库+词汇+作文; ⚙️ 管理隐藏) / **真删主页"📋 更多详情"折叠区** (主页 "2 卡极简" 真兑现) / **错题 modal 加 Cloze topic 主题聚类显示** (travel/school/nature/emotion 8 主题计数 + ✓3件事数) / **作文 60% 模板词锁→软提示** (V2 奖励按命中率 +10/+5/+2 分级)

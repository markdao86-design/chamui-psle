...
**孩子起点 AL** (2026-08 校考真实数据, 取代 2026-05 旧表):

| 科目 | AL | 目标 | 缺口 |
|---|---|---|---|
| **英语** | **AL6** (26/40) | **AL1 (90+)** | **最大缺口**; 弱项=阅读问答踩点/Editing/完形/词汇辨析/情景写作 |
| **科学** | AL3 (30.5/40) | **AL1 (90+)** | 丢分大头是选择题 (-8) |
| **华文** | AL2 (43/50) | **AL1 (90+)** | 阅读大题 -7 全是"少写点"; **读普通华文, 不是高华** |
| **数学** | AL1 | **维持 AL1** | 防粗心 |
| **合计** | **AL12** | **综合 AL4** | |

**总目标 综合 AL: 4** = **四科全部 AL1 (每科 90 分以上)** — 2026-09-05 用户明确。
⚠️ **口径铁律: 全站文案/题目/预测一律按 AL1 写, 不要再出现 "AL 4-6" "75-89%" "目标 AL2" 这类旧口径。**
AL1 的含义不是"会做难题", 是"不丢该拿的分" — 全卷只有 10 分容错, 所以内容和反馈都要往"零失误"引。
...
- **app 主目的**: 帮孩子四科全部拿 AL1 (综合 AL4)
- **副标题** (主页显示, 改动前问用户): "PSLE 4-6 分陪练 · 打卡是养成, 能力才是目标"
...
孩子当前 (2026.8 校考): 英 AL6 + 数 AL1 + 科 AL3 + 华 AL2 = **综合 AL12** → 目标 **综合 AL4 (四科全 AL1)**, 立化/华侨 COP6 仍有 2 分余量
...
**铁律: 亮色主题 (--color-bg: #F1F5F9 浅灰蓝底 + 白卡片), 不要再写任何暗色底/亮色字。**
...
| 主色(品蓝) | #1E40AF (--color-primary), 亮蓝 #1E40AF |
| 主文字 | #1E293B (--color-text) |
| 副文字 | #64748B (--color-text-light) / 弱灰 #909399 |
| 边框 | #E2E8F0 (--color-border) / 分隔 #EEF1F6 |
| 强调 | 绿 #16A34A · 橙 #B45309 · 警告黄 #E6A23C · 红 #DC2626(小面积) · 紫 #7C3AED · 粉 #DB2777 |
...
2. [ ] 文字: #1E293B 主 / #64748B 副 — 不写 #E0E0E0/#A0A0A0 类亮灰
3. [ ] 强调字用上表深色版 (#1E40AF/#16A34A/#D97706) — 不写 #4FC3F7/#66FFB0/#FFB74D 类荧光亮版
4. [ ] 按钮 CTA 保留鲜艳实底 + 白字

...
- **科学 OE 15 道** (v19.14g 计划扩到 50) + **硬规则自动评分** (v19.14d) + **章节 filter** (v19.14f)
...
### v19.14g 候选 (科学内容扩充)
1. **科学 OE 15 → 50 题** (按手册 4 难章配比: Plant Transport+6, Digestive+6, Light+5, Heat+7, 实验设计+5, Photosynthesis+3, 其他+3)
2. **SCIENCE_MCQ 70 道补 topic 字段** (现在用 keyword 子串匹配, 召回率 70-85%, 补 topic 可到 100%)

### v19.14h+ UI 收尾 (UI/UX 专家未做项)
3. **9 tab → 5 tab** (合并 知识树/题库/词汇/作文 → 📚 练习; 隐藏 ⚙️ 管理)
4. **字号 11/10 → 13/12px** 全局 (WCAG AA 违反, 3 版未改)
5. **真删主页 hero-section + learningPortrait + dashboard-collapse** (主页 "2 卡" 是谎言, 还有 8+ 折叠卡)

...
const VOCAB_EN = {
  ...
  'give in': 'to stop fighting and agree to something',
  'look up to': 'to admire and respect someone',
  'turn out': 'to happen or end in a certain way',
  'set off': 'to start a journey',
  'put up with': 'to accept something annoying without complaining',
  'break down': 'to stop working, or to cry a lot',
  'look forward to': 'to feel happy about something coming soon',
  'take after': 'to look or act like a parent',
  ...
  'figure out': 'to think hard and understand something',
  'cut down on': 'to do or use less of something',
  'keep up with': 'to move or learn as fast as others',
  'give up': 'to stop trying to do something',
  'look into': 'to check or study something carefully',
  'put off': 'to move something to a later time',
  'take over': 'to take control of something',
  'turn down': 'to say no to an offer',
  'break into': 'to enter a place by force',
  'come up with': 'to think of a plan or idea',
  'go through': 'to live through a hard experience',
  'call off': 'to cancel something planned',
  'hand in': 'to give work to a teacher or boss',
  'pick up': 'to lift something, or to collect a person',
  'drop off': 'to take someone somewhere, or to fall',
  'stand out': 'to be easy to notice',
  'hold on': 'to wait, or to keep gripping tightly',
  'pass away': 'a polite way to say someone died',
  'show off': 'to try to make people admire you',
  'take place': 'to happen',
  'work out': 'to solve, or to exercise the body',
  'point out': 'to show or tell someone about something',
  'end up': 'to finally be in a place or state',
  'let down': 'to disappoint someone',
  'back up': 'to support someone, or to save a copy',
  'sort out': 'to fix a problem or tidy things',
  'pass down': 'to give something to younger people over time',
  'fall behind': 'to be slower or later than others',
  'count on': 'to depend on someone for help',
  'pull through': 'to get better after a hard time',
  'dawn on': 'to suddenly become clear to someone',
  'blow over': 'when trouble slowly calms down',
  'own up': 'to admit you did something wrong',
  'wear off': 'when an effect slowly goes away',
  'die down': 'to slowly become weaker or quieter',
  'live up to': 'to be as good as people hoped',
  'however': 'a word meaning but',
  'although': 'even though something is true',
  'despite': 'in spite of something',
  'nevertheless': 'even so, but still',
  ...
  'moreover': 'and also, what is more',
  'in addition': 'as well, plus',
  'besides': 'also, on top of that',
  'instead': 'in place of something else',
  'otherwise': 'if not, or else',
  'on the other hand': 'looking at the opposite side',
  'eventually': 'in the end, after a while',
  'meanwhile': 'at the same time',
  'subsequently': 'after that, later',
  'for instance': 'for example',
  'in fact': 'used to show what is really true',
  ...
  'hence': 'for this reason, so',
  'anxious': 'worried and nervous',
  'reluctant': 'not wanting to do something',
  'determined': 'wanting very much to do something',
  'grateful': 'feeling thankful',
  'furious': 'very, very angry',
  'horrified': 'shocked and very scared',
  'stunned': 'so surprised you cannot move or speak',
  'bewildered': 'very confused',
  'elated': 'extremely happy and excited',
  'ecstatic': 'feeling very great joy',
  'overjoyed': 'extremely happy',
  'devastated': 'very, very sad and upset',
  'miserable': 'very unhappy',
  'dejected': 'sad and without hope',
  'embarrassed': 'shy and uncomfortable about something',
  ...
  'compassionate': 'kind and caring about others',
  'generous': 'happy to give and share',
  'enthusiastic': 'full of excitement and interest',
  'remorseful': 'feeling sorry for a wrong you did',
  'optimistic': 'hoping good things will happen',
  'pessimistic': 'expecting bad things to happen',
  'indignant': 'angry about something unfair',
  'overwhelmed': 'feeling it is all too much to handle',
  'apprehensive': 'worried about something ahead',
  'exasperated': 'very annoyed and frustrated',
  'nonchalant': 'calm and not seeming to care',
  'defiant': 'refusing to obey',
  'skeptical': 'not sure something is true',
  'sympathetic': 'kind to someone who is sad',
  'wistful': 'sadly wishing for something',
  'exclaimed': 'said something suddenly and loudly',
  'murmured': 'said something softly and quietly',
  'stammered': 'spoke with nervous pauses and repeats',
  'muttered': 'said something quietly and unclearly',
  'whispered': 'spoke very softly',
  'shrieked': 'gave a loud high scream',
  'bellowed': 'shouted in a loud deep voice',
  'dashed': 'ran very fast',
  ...
  'stumbled': 'tripped and almost fell',
  'glanced': 'looked quickly',
  'peered': 'looked closely and hard to see',
  'gazed': 'looked at something for a long time',
  'stared': 'looked at something without moving your eyes',
  'clutched': 'held something tightly',
  'snatched': 'grabbed something quickly',
  'grabbed': 'took hold of something suddenly',
  'shoved': 'pushed roughly',
  'hesitated': 'paused because you were unsure',
  'persevered': 'kept trying and did not give up',
  'plunged': 'jumped or fell down quickly',
  'emerged': 'came out into view',
  'vanished': 'disappeared suddenly',
  'flinched': 'moved back suddenly from fear or pain',
  'embraced': 'hugged someone',
  'persuaded': 'made someone agree by talking to them',
  'leapt': 'jumped high or far',
  'crept': 'moved slowly and quietly',
  'trembled': 'shook because of fear or cold',
  'lunged': 'moved forward suddenly and quickly',
  'dodged': 'moved fast to avoid something',
  'slumped': 'sank down heavily and limply',
  'beamed': 'smiled in a big happy way',
  'scowled': 'made an angry face',
  'winced': 'made a face from sudden pain',
  'retreated': 'moved back away from something',
  'beckoned': 'waved to tell someone to come',
  'scorching': 'very, very hot',
  'freezing': 'very, very cold',
  'drenched': 'completely wet',
  'deafening': 'so loud it hurts your ears',
  'piercing': 'very sharp and loud, or very sharp',
  'soothing': 'calming and gentle',
  'peculiar': 'strange or odd',
  'bizarre': 'very strange and weird',
  'eerie': 'strange and a little scary',
  'immense': 'extremely big',
  'vast': 'very large in size',
  'enormous': 'extremely big',
  'fragile': 'easily broken',
  'sturdy': 'strong and not easily broken',
  'vivid': 'bright and very clear',
  'faint': 'weak and hard to see or hear',
  'serene': 'calm and peaceful',
  'tranquil': 'quiet and peaceful',
  'ominous': 'making you feel something bad will happen',
  'gloomy': 'dark and sad',
  'radiant': 'shining brightly',
  'bleak': 'cold, bare and without hope',
  'congested': 'too full and crowded',
  'deserted': 'empty with no people',
  'magnificent': 'very grand and beautiful',
  'shabby': 'old and in poor condition',
  ...
  'pristine': 'clean and brand new',
  'cramped': 'too small and tight for space',
  'spacious': 'having lots of room',
  'bustling': 'full of busy activity',
  'stifling': 'so hot and stuffy it is hard to breathe',
  'pungent': 'having a strong sharp smell',
  'musty': 'smelling old and damp',
  'shrill': 'high, sharp and unpleasant to hear',
  ...
  'emphasize': 'to show something is important',
  'essential': 'very needed, must have',
  'obvious': 'very easy to see or understand',
  'potential': 'the ability to grow or succeed',
  'remarkable': 'very special and worth noticing',
  'merely': 'only, just',
  'gradually': 'slowly, bit by bit',
  'apparently': 'it seems that, as it appears',
  'deliberately': 'done on purpose',
  'fortunately': 'luckily',
  'unfortunately': 'sadly, by bad luck',
  'increasingly': 'more and more',
  'effectively': 'in a way that works well',
  'considerably': 'by a large amount',
  'particularly': 'especially',
  'previously': 'before now, earlier',
  'ultimately': 'in the end, finally',
  'approximately': 'about, roughly',
  'drastically': 'in a big and sudden way',
  'simultaneously': 'at the same time',
  'numerous': 'very many',
  'adequate': 'enough for what is needed',
  'sufficient': 'as much as needed',
  'excessive': 'too much',
  'inevitable': 'sure to happen, cannot be avoided',
  'substantial': 'large in amount',
  'prominent': 'important and well known',
  'crucial': 'extremely important',
  'accumulate': 'to build up over time',
  'deteriorate': 'to slowly get worse',
  'a wide range of': 'many different kinds of',
  'at the expense of': 'by losing or harming something else',
  'in the nick of time': 'just before it was too late',
  'out of the blue': 'happening suddenly and by surprise',
  'take for granted': 'to not value something you have',
  'make the most of': 'to use something as well as you can',
  'to no avail': 'without success',
  'without a doubt': 'for sure, certainly',
  'at a loss': 'not knowing what to do',
  'once in a while': 'sometimes, not often',
  'in vain': 'without success',
  'at stake': 'in danger of being lost',
  'by all means': 'yes, of course',
  'on the verge of': 'about to do or have something',
  ...
  'once bitten twice shy': 'being careful after being hurt before',
  'the last straw': 'the final small problem that makes you snap',
  'a drop in the ocean': 'a tiny amount compared to what is needed',
  ...
  'every cloud has a silver lining': 'every bad thing has some good in it',
  "keep one's fingers crossed": 'to hope for good luck',
  'butterflies in stomach': 'a nervous feeling before something',
  'dawn upon': 'to suddenly become clear to someone',
  'see eye to eye': 'to fully agree with someone',
  "a stone's throw away": 'very close, a short distance away',
  "at the top of one's lungs": 'as loudly as you can',
  'break the ice': 'to make people feel less shy at first',
  'go the extra mile': 'to try harder than expected',
  'hit the nail on the head': 'to say exactly the right thing',
  'add fuel to the fire': 'to make a bad situation worse',
  'nip in the bud': 'to stop a problem before it grows',
  'photosynthesis': 'how green plants make food using sunlight',
  'respiration': 'how living things get energy from food',
  'transpiration': 'when plants lose water through their leaves',
  'germination': 'when a seed starts to grow',
  'reproduction': 'how living things make more of their own kind',
  'pollination': 'moving pollen so plants can make seeds',
  'fertilization': 'when a male cell joins a female cell',
  'chlorophyll': 'the green stuff in plants that traps sunlight',
  'chloroplast': 'the plant part where food is made',
  'stomata': 'tiny holes in leaves that let gases in and out',
  'xylem': 'the tube in a plant that carries water upward',
  'phloem': 'the tube in a plant that carries food',
  'cell membrane': 'the thin layer around a cell',
  'cell wall': 'the stiff outer layer of a plant cell',
  'nucleus': 'the control centre of a cell',
  'vacuole': 'the space in a cell that stores water',
  'mitochondria': 'the cell part that makes energy',
  'organism': 'any living thing',
  'species': 'a group of living things of the same kind',
  'habitat': 'the natural home of an animal or plant',
  'ecosystem': 'living things and their surroundings together',
  'food chain': 'the order of who eats what',
  ...
  'adaptation': 'a body or habit that helps an animal survive',
  'camouflage': 'colours that help an animal blend in and hide',
  'hibernation': 'a long deep sleep through winter',
  'migration': 'moving to another place with the seasons',
  'vertebrate': 'an animal with a backbone',
  'invertebrate': 'an animal without a backbone',
  'mammal': 'an animal that feeds its babies milk',
  ...
  'solid': 'matter with a fixed shape',
  'liquid': 'matter that flows and takes its container shape',
  'gas': 'matter that spreads out to fill any space',
  'evaporation': 'when a liquid slowly turns into a gas',
  'condensation': 'when a gas turns back into a liquid',
  'boiling': 'when a liquid heats up and turns to gas fast',
  'melting': 'when a solid turns into a liquid',
  'conduction': 'heat moving through a solid by touching',
  'convection': 'heat moving through liquids and gases',
  'radiation': 'heat travelling as rays through space',
  'conductor': 'a material that lets heat or electricity pass',
  'insulator': 'a material that does not let heat or electricity pass',
  'temperature': 'how hot or cold something is',
  'thermometer': 'a tool that measures temperature',
  'force': 'a push or a pull',
  'friction': 'a force that slows down sliding objects',
  'gravity': 'the force that pulls things toward Earth',
  'magnetic force': 'the pull or push of a magnet',
  'inertia': 'the tendency of objects to stay as they are',
  ...
  'light': 'the energy that lets us see',
  'shadow': 'the dark shape made when light is blocked',
  'reflection': 'when light bounces off a surface',
  'refraction': 'when light bends passing through water or glass',
  'transparent': 'letting all light pass through, see-through',
  'translucent': 'letting some light through but not clear',
  'opaque': 'not letting any light through',
  'circuit': 'a path that electricity flows around',
  'series circuit': 'a circuit with one single loop',
  'parallel circuit': 'a circuit with more than one path',
  'current': 'the flow of electricity',
  'voltage': 'the push that makes electricity flow',
  'resistance': 'how much a material slows down current',
  'experiment': 'a test to find out something',
  'hypothesis': 'a guess you test in an experiment',
  'observation': 'something you notice by watching carefully',
  'conclusion': 'what you decide after an experiment',
  'variable': 'something that can change in an experiment',
  'independent variable': 'the thing you change on purpose',
  'dependent variable': 'the thing you measure to see what changes',
  'controlled variable': 'the thing you keep the same',
  ...
  'data': 'facts and numbers you collect',
  'apparatus': 'the tools used in an experiment',
  'beaker': 'a glass cup for holding liquids in science',
  'measuring cylinder': 'a tall tube for measuring liquid amounts',
  'test tube': 'a thin glass tube for small samples',
  'magnifying glass': 'a lens that makes small things look bigger',
  'dissolve': 'when a solid mixes into a liquid and disappears',
  'filter': 'to separate solids from a liquid',
  ...
  'water cycle': 'how water moves between sky, land and sea',
  'precipitation': 'water falling as rain, snow or hail',
  'carbon dioxide': 'a gas we breathe out, used by plants',
  'oxygen': 'a gas in air that living things need to breathe',
  ...
  'diameter': 'the distance right across a circle through the centre',
  ...
  'right-angled': 'having a ninety degree angle',
  'acute': 'an angle smaller than ninety degrees',
  'obtuse': 'an angle bigger than ninety degrees',
  'reflex': 'an angle bigger than one hundred eighty degrees',
  'vertex': 'a corner point where lines meet',
  ...
  'cuboid': 'a box shape with six rectangle faces',
  'cube': 'a box shape with six equal square faces',
  'cylinder': 'a shape like a can or tube',
  'cone': 'a shape with a round base and a point on top',
  'sphere': 'a perfectly round ball shape',
  'prism': 'a solid with the same shape all along its length',
  'pyramid': 'a shape with a flat base and sides meeting at a point',
  'symmetry': 'when both halves of a shape match',
  'tessellation': 'shapes fitting together with no gaps',
  'net': 'a flat shape you fold to make a solid',
  'quotient': 'the answer when you divide one number by another',
  ...
  'improper fraction': 'a fraction where the top is bigger than the bottom',
  'equivalent fraction': 'a fraction equal in value to another',
  'simplest form': 'a fraction made as small as it can be',
  'decimal': 'a number with a point, like two point five',
  ...
  'ratio': 'a way to compare amounts, like two to three',
  'proportion': 'when two ratios are equal',
  'percentage': 'a number out of one hundred',
  'discount': 'money taken off the normal price',
  'profit': 'money gained after selling something',
  'loss': 'money lost when you sell for less',
  'GST': 'a tax added to the price of things',
  'interest': 'extra money paid for borrowing or saving',
  'average': 'the middle value found by sharing equally',
  'median': 'the middle number when values are in order',
  'mode': 'the value that appears most often',
  'ascending': 'going up from small to big',
  'descending': 'going down from big to small',
  'estimate': 'to guess an amount that is close',
  'approximate': 'close to the real value but not exact',
  'round off': 'to change a number to a simpler nearby one',
};
function _vocabEn(key, word) { return (typeof VOCAB_EN !== "undefined") ? (VOCAB_EN[key] || VOCAB_EN[word] || "") : ""; }

function getVocabMeta(word) {
  const key = (word || '').toLowerCase();
  const meta = VOCAB_META[key] || VOCAB_META[word];
  if (meta) return { sent: meta.s, qtype: meta.q, en: _vocabEn(key, word) };
  ...
  if (typeof FLASHCARD_DECKS !== 'undefined') {
    ...
    return { sent: '', qtype: _DECK_QTYPE_FALLBACK[cat] || '', en: _vocabEn(key, word) };
  }
  return { sent: '', qtype: '', en: _vocabEn(key, word) };
}

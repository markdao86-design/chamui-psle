...
// ============= v18.26+v18.41: 知识树 (4 学科 × ~10 节点, 含讲解 + 例子 + 关联游戏) =============
const KNOWLEDGE_TREE = {
  '🔬 科学': [
    { id: 'sci_diversity', name: 'Diversity 分类', weeks: [1, 2], icon: '🦋',
      desc: '动物分 5 大类 (哺乳/鸟/鱼/爬行/两栖); 植物按"开花/不开花"分;材料按性质分类。',
      examples: ['哺乳: 胎生哺乳, 体毛 (猫狗)', '鸟: 卵生有羽毛 (鹰)', '导体 vs 绝缘体'],
      game: 'scilab' },
    { id: 'sci_plant_lc', name: '植物生命周期', weeks: [3, 4], icon: '🌱',
      desc: '种子 → 萌发 → 幼苗 → 成熟 → 开花结果 → 新种子。萌发需要水/空气/温度。',
      examples: ['种子内: seed coat / embryo / cotyledon', '蝴蝶花需虫媒授粉'],
      game: 'scilab' },
    { id: 'sci_material', name: '材料性质', weeks: [5, 6], icon: '🧪',
      desc: '材料按导电/导热/磁性/透光等性质分类。每种材料有用途。',
      examples: ['铜=导体导热', '塑料=绝缘体轻便', '玻璃=透光易碎'],
      game: 'scilab' },
    { id: 'sci_forces', name: '力 Forces', weeks: [7, 9], icon: '⚙️',
      desc: '力让物体运动/停止/改变方向。常见: 摩擦/重力/磁力/弹力。',
      examples: ['摩擦让车停下', '磁力可隔空作用'],
      game: 'scilab' },
    { id: 'sci_light_heat', name: '光与热', weeks: [10, 12], icon: '💡',
      desc: '光直线传播, 遇障碍反射/折射; 热从高温传到低温, 三方式: 传导/对流/辐射。',
      examples: ['镜子=反射', '水中筷子弯=折射', '太阳光=辐射加热'],
      game: 'scilab' },
    { id: 'sci_cells', name: '细胞 Cells', weeks: [13, 15], icon: '🔬',
      desc: '生物体由细胞组成。植物细胞有细胞壁 + 叶绿体, 动物细胞没有。',
      examples: ['植物细胞: 细胞壁/叶绿体/液泡', '动物细胞: 细胞膜/细胞核/线粒体'],
      game: 'vocab' },
    { id: 'sci_water', name: '水循环', weeks: [16, 18], icon: '💧',
      desc: '水循环 4 步: 蒸发 → 凝结 → 降水 → 径流。太阳是动力源。',
      examples: ['湖水蒸发→水蒸气', '空中凝结→云', '云降水→雨/雪'],
      game: 'vocab' },
    { id: 'sci_reproduction', name: '生殖', weeks: [19, 21], icon: '🌿',
      desc: '动物有性 (受精) 和无性 (出芽). 植物也分有性 (花)和无性 (扦插).',
      examples: ['完全变态: 蝶 4 段 (卵→幼虫→蛹→成虫)', '不完全: 蝗 3 段'],
      game: 'scilab' },
    { id: 'sci_energy', name: '能量 Energy', weeks: [22, 26], icon: '⚡',
      desc: '能量不消失, 只转化。形式: 热/光/电/动能/化学能/声音/重力势能。',
      examples: ['电池=化学能→电能', '灯泡=电能→光+热', '光合=光→化学'],
      game: 'scilab' },
    { id: 'sci_adaptations', name: 'P6 适应', weeks: [27, 42], icon: '🦎',
      desc: '生物适应环境: 结构/行为/生理。沙漠动物耐高温缺水, 极地厚毛保温。',
      examples: ['仙人掌=刺减少蒸发', '北极熊=厚毛+脂肪', '骆驼=驼峰储水'],
      game: 'vocab' },
    { id: 'sci_revision', name: 'PSLE 复习', weeks: [43, 65], icon: '📚',
      desc: '过 PSLE 5 大主题: Cycles, Diversity, Energy, Interactions, Systems。每主题刷题。',
      examples: ['看 PSLE 真题题型', '答题用 4 要素: IV/DV/CV/Hypothesis'],
      game: 'scilab' },
    { id: 'sci_psle', name: 'PSLE 笔试', weeks: [66, 73], icon: '🎯', milestone: 'W73',
      desc: '考 2 张卷: Booklet A (MCQ) + B (Open-ended)。答 4 要素必给分。',
      examples: ['一字一分概念', '画图必标 axis + units'],
      game: 'scilab' }
  ],
  '📖 英语': [
    { id: 'eng_basics', name: '基础 Grammar', weeks: [1, 4], icon: '✏️',
      desc: '主谓一致 + 时态 + 介词 + 冠词 — Editing 5 类错的根源。',
      examples: ['He goes (3rd 单数 +s)', 'I have finished (现在完成)', 'on Monday / in May'],
      game: 'grammar' },
    { id: 'eng_comp', name: 'Comprehension P5', weeks: [5, 10], icon: '📖',
      desc: '答案 90% 在原文里。先看题找关键词, 回原文摘下来稍改。',
      examples: ['What/Why/How → 直接找原文', '推断题 → 抓证据再推', '主旨 → 看首末段'],
      game: 'editing' },
    { id: 'eng_cloze', name: 'Cloze 填空', weeks: [11, 14], icon: '🧩',
      desc: '70% 是介词/冠词。看上下文判断。常考 phrasal verbs。',
      examples: ['look at/after/for/up', 'come across=偶遇', 'put off=推迟'],
      game: 'cloze' },
    { id: 'eng_editing', name: 'Editing 改错', weeks: [15, 18], icon: '🔍',
      desc: '5 类 95%: 主谓/时态/拼写/介词/冠词. 一段 50 词找 5 错。',
      examples: ['Yesterday I am hungry → was', 'a apple → an', 'He go → goes'],
      game: 'editing' },
    { id: 'eng_writing', name: '作文 Composition', weeks: [19, 26], icon: '✒️',
      desc: '150-200 字叙事。开头 3 句定调: 用感官描写; 至少 1 个高级词加 5 分。',
      examples: ['crestfallen=沮丧', 'jubilant=欢欣', 'dawned upon me=顿悟'],
      game: 'vocab' },
    { id: 'eng_listening', name: '听力 Listening', weeks: [27, 42], icon: '🎧', milestone: 'W42',
      desc: '答案 90% 在 but/however 转折后。数字易错: fifteen vs fifty 重音不同。',
      examples: ['听 13 vs 30 重音区分', 'although + 关键信息'],
      game: 'listen' },
    { id: 'eng_oral', name: '口试 Oral', weeks: [43, 65], icon: '🗣️', milestone: 'W68',
      desc: '流畅 > 完美。卡 1 次 -1 分, 错 1 词 -0.5。简单词流畅说优先。',
      examples: ['用模板句开头: I think... / In my view...', '错就跳过别纠结'],
      game: 'vocab' },
    { id: 'eng_psle', name: 'PSLE 笔试', weeks: [66, 73], icon: '🎯', milestone: 'W73',
      desc: '考 2 张卷 + 听力 + 口试. Paper 1 = 写作; Paper 2 = grammar/cloze/comp.',
      examples: ['作文跑题 0 分', 'Comp 一字一分'],
      game: 'editing' }
  ],
  '➗ 数学': [
    { id: 'math_basics', name: '四则运算', weeks: [1, 3], icon: '🔢',
      desc: '+ - × ÷ 含混合运算. 先算括号 → 乘除 → 加减.',
      examples: ['2 + 3 × 4 = 14 (不是 20)', '(2+3) × 4 = 20'],
      game: 'math' },
    { id: 'math_fractions', name: '分数', weeks: [4, 7], icon: '½',
      desc: '分数 + - × ÷; 通分; X/Y of Z = X/Y × Z. 别忘约分.',
      examples: ['3/4 + 1/4 = 1', '2/3 of 18 = 12', '5/8 of 24 = 15'],
      game: 'math' },
    { id: 'math_decimals', name: '小数', weeks: [8, 10], icon: '0.5',
      desc: '小数转分数: 0.25 = 1/4. 小数加减按位对齐.',
      examples: ['0.5 + 0.25 = 0.75', '1.5 × 4 = 6.0'],
      game: 'math' },
    { id: 'math_percent', name: '百分比', weeks: [11, 13], icon: '%',
      desc: 'X% of Y = X/100 × Y. 别忘 ÷100. 折扣 = 原价 × (1 - 折扣率).',
      examples: ['20% × 45 = 9', '20% off $85 = pay $68', 'GST 9%: $250 → $272.5'],
      game: 'unit' },
    { id: 'math_ratio', name: '比例', weeks: [14, 16], icon: '⚖️',
      desc: 'A:B = 2:3 → A = 2份, B = 3份, 总 5份. 单位 = 总值/总份数.',
      examples: ['A:B=2:3, 总 25, A=10 B=15', 'A:B=2:3 B:C=4:5 → A:C=8:15'],
      game: 'math' },
    { id: 'math_speed', name: '速度', weeks: [17, 19], icon: '🏃',
      desc: '速度 = 距离 ÷ 时间. 单位匹配 (km/h vs m/s).',
      examples: ['120 km in 1.5h → 80 km/h', '60 km in 30 min → 120 km/h'],
      game: 'unit' },
    { id: 'math_geometry', name: '几何', weeks: [20, 23], icon: '📐',
      desc: '周长 = 各边和; 矩形面积 = 长×宽; 三角形 = 底×高÷2; 圆 = πr².',
      examples: ['8×5 矩形周长=26 面积=40', '底 12 高 8 三角形=48', 'r=7 圆面积≈154'],
      game: 'unit' },
    { id: 'math_word_problems', name: '应用题', weeks: [24, 42], icon: '📝',
      desc: '画图! 标已知/未知. 用模型法 (Singapore method).',
      examples: ['模型法 bar diagram', '答完检查单位 + 是否合理'],
      game: 'math' },
    { id: 'math_psle_paper1', name: 'P5 paper 1+2', weeks: [27, 52], icon: '🎯',
      desc: 'Paper 1 = MCQ 50min; Paper 2 = 长题 100min. 时间分配关键.',
      examples: ['Paper 1: 1.5 min/题', 'Paper 2: 难题留 30 min'],
      game: 'math' },
    { id: 'math_psle', name: 'PSLE 笔试', weeks: [66, 73], icon: '🏆', milestone: 'W73',
      desc: 'PSLE 数学 2 张卷. 答案有单位必写, 步骤完整.',
      examples: ['漏单位 -1', '逻辑跳跃 -2'],
      game: 'math' }
  ],
  '🇨🇳 华文': [
    { id: 'ch_basic', name: '基础词汇', weeks: [1, 6], icon: '汉',
      desc: '常见成语 + 反义/同义/造句. PSLE 高华考 200+ 高频成语.',
      examples: ['一丝不苟 (meticulous)', '锲而不舍 (persevere)'],
      game: 'vocab' },
    { id: 'ch_reading', name: '阅读理解', weeks: [7, 14], icon: '📖',
      desc: '抓段落主旨, 不纠结生字. 答案在原文.',
      examples: ['看题再读文', '关键词回扣原文'],
      game: 'vocab' },
    { id: 'ch_composition', name: '作文', weeks: [15, 26], icon: '✒️',
      desc: '叙事/议论. 开头点题, 中间举例, 结尾升华.',
      examples: ['描写感官: 听见/闻到/触摸', '高级词: 浮现/迸发/不胫而走'],
      game: 'vocab' },
    { id: 'ch_oral', name: '口试', weeks: [27, 65], icon: '🗣️',
      desc: '看图说话 + 个人对话. 流畅最重要, 用模板句.',
      examples: ['首先...其次...最后...', '在我看来 / 据我所知'],
      game: 'vocab' },
    { id: 'ch_psle', name: 'PSLE', weeks: [66, 73], icon: '🎯', milestone: 'W73',
      desc: 'PSLE 高华 = paper 1 (作文) + paper 2 (阅读+成语+造句).',
      examples: ['paper 1 慢思快写', 'paper 2 看清题再答'],
      game: 'vocab' }
  ]
};
